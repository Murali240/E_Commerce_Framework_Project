...
public class VerifyPageScrollDownAndUpArrowFunctionalityTest extends BaseTest {
	
	HomePage homePage;
	
	@Test
    public void verifyPageScrollDownAndUpArrow() {
        ...
        ExtentManager.getTest().info("Scrolled down to the bottom of the page successfully");
        ...
        /** Step 3: Click on 'Scroll Up' arrow button */
        homePage.clickScrollUpArrow();
        WaitUtils.waitForSeconds(driver, 1);
        ExtentManager.getTest().info("Clicked on 'Scroll Up' arrow button");
        ...
        ExtentManager.getTest().pass("<b>Scroll Down and Scroll Up arrow</b> functionality is working as expected");
